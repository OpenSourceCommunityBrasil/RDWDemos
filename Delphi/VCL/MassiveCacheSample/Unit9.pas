...
uses
  ...
  uRESTDWConsts, Vcl.Grids, Vcl.DBGrids, uRESTDWMassiveBuffer, Vcl.DBCtrls,
  uRESTDWAbout, uRESTDWBasicTypes, uRESTDWBasicDB, uRESTDWDataUtils,
  uRESTDWComponentBase, uRESTDWIdBase;
...
type
  TForm9 = class(TForm)
    ...
    DBGrid1: TDBGrid;
    DBGrid2: TDBGrid;
    DWMassiveCache1: TRESTDWMassiveCache;
