...
USES
  ...
  FireDAC.Phys.MSSQL,
  uRESTDWConsts, uRESTDWServerEvents, FireDAC.Stan.Param, FireDAC.DatS,
  FireDAC.DApt.Intf, FireDAC.Comp.DataSet, uRESTDWServerContext,
  uRESTDWAbout, uRESTDWBasic, uRESTDWParams;
...
procedure TServerMethodDM.RESTDWServerEvents1Eventsdwevent1ReplyEvent(
  var Params: TRESTDWParams; var Result: string);
begin
...
procedure TServerMethodDM.RESTDWServerEvents1EventshelloworldReplyEvent(
  var Params: TRESTDWParams; var Result: string);
begin
