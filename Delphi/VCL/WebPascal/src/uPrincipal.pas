...
type
  TfPrincipal = class(TForm)
    ...
    procedure cbAuthorizationTokenClick(Sender: TObject);
  Private
...
procedure TfPrincipal.cbAuthorizationTokenClick(Sender: TObject);
begin
 If cbAuthorizationToken.Checked Then
  RESTDWIdServicePooler1.Authenticator := RESTDWAuthToken1
 Else
  RESTDWIdServicePooler1.Authenticator := Nil;
end;
