...
Uses
  ...
  uRESTDWComponentBase, uRESTDWParams, uRESTDWTools, uRESTDWDriverBase,
  uRESTDWFireDACDriver, uRESTDWMemoryDataset
...
function TDMWebPascal.SoNumero(fField : String): String;
var
  I : Byte;
begin
   Result := '';
