...
TYPE
  TServerMethodDM = CLASS(TServerMethodDataModule)
    ...
    RDWSEDados: TRESTDWServerEvents;
...
procedure TServerMethodDM.employeeReplyEvent(var Params: TRESTDWParams; dJsonMode : TJsonMode; Var Result : String);
Var
...
procedure TServerMethodDM.RDWSEDadosEventshelloworldReplyEventByType(
  var Params: TRESTDWParams; var Result: string;
  const RequestType: TRequestType; var StatusCode: Integer;
  RequestHeader: TStringList);
begin
 ...
 Else
  Begin
   Result := 'Hello World RDW Refactor...' + sLineBreak +
             Format('Params em URI Param 0 = %s, Param 1 = %s', [Params.ItemsString['temp1'].AsString,
