...
Uses
  ...
  Vcl.StdCtrls, Vcl.ExtCtrls, Vcl.Imaging.Jpeg, Vcl.Imaging.Pngimage, Vcl.Mask,
  ...
  uREStDWJSONObject, uRESTDWAbout, uRESTDWBasic, uRESTDWIdBase, uRESTDWConsts,
  uRESTDWDataUtils, uRESTDWComponentBase,

  uDMPrincipal, uDMSecundario, USock;
