...
USES
  ...
  uRESTDWJSONObject, Dialogs, DataUtils, FireDAC.Dapt, FireDAC.Phys.FBDef,
  ...
  FireDAC.DatS, FireDAC.DApt.Intf, FireDAC.Comp.DataSet, uRESTDWAbout, FireDAC.Phys.MySQLDef,
...
TYPE
  TServerMethodDM2 = CLASS(TServerMethodDataModule)
    ...
    procedure DWServerEvents1EventseventdatetimeReplyEvent(
      var Params: TRESTDWParams; var Result: string);
    procedure DWServerEvents1EventshelloworldReplyEvent(var Params: TRESTDWParams;
      var Result: string);
    procedure DWServerEvents2Eventshelloworld2ReplyEvent(var Params: TRESTDWParams;
      var Result: string);
    ...
    procedure DWServerEvents1EventsassynceventReplyEvent(var Params: TRESTDWParams;
      var Result: string);
    procedure DWServerEvents1EventshelloworldRDWReplyEvent(
      var Params: TRESTDWParams; var Result: string);
    procedure FDQuery1AfterScroll(DataSet: TDataSet);
    procedure DWSETESTEEventsservertimeReplyEventByType(var Params: TRESTDWParams;
  ...
  PRIVATE
    ...
    procedure employeeReplyEvent(var Params: TRESTDWParams; dJsonMode: TJsonMode; Var Result : String);
  PUBLIC
    { Public declarations }
  END;

VAR
  ServerMethodDM2: TServerMethodDM2;
...
procedure TServerMethodDM2.employeeReplyEvent(var Params: TRESTDWParams; dJsonMode : TJsonMode; Var Result : String);
Var
...
procedure TServerMethodDM2.FDQuery1AfterScroll(DataSet: TDataSet);
begin
...
procedure TServerMethodDM2.dwcrEmployeeItemsdatatableRequestExecute(
  const Params: TRESTDWParams; var ContentType, Result: string);
Var
 JSONValue :  TJSONValue;
begin
...
procedure TServerMethodDM2.DWServerContext1ContextListangularReplyRequest(
  const Params: TRESTDWParams; var ContentType, Result: string;
  const RequestType: TRequestType);
var
 s : TStringlist;
...
procedure TServerMethodDM2.DWServerContext1ContextListindexReplyRequest(
  const Params: TRESTDWParams; var ContentType, Result: string;
  const RequestType: TRequestType);
var
 s : TStringlist;
...
procedure TServerMethodDM2.DWServerContext1ContextListindexReplyRequestStream(
  const Params: TRESTDWParams; var ContentType: string; const Result: TMemoryStream;
  const RequestType: TRequestType; var StatusCode: Integer);
begin
...
procedure TServerMethodDM2.DWServerContext1ContextListinitReplyRequest(
  const Params: TRESTDWParams; var ContentType, Result: string;
  const RequestType: TRequestType);
begin
 Result := '<!DOCTYPE html> ' +
...
procedure TServerMethodDM2.DWServerContext1ContextListopenfileReplyRequestStream(
  const Params: TRESTDWParams; var ContentType: string; const Result: TMemoryStream;
  const RequestType: TRequestType; var StatusCode: Integer);
Var
 vNotFound   : Boolean;
...
procedure TServerMethodDM2.DWServerContext1ContextListphpReplyRequest(
  const Params: TRESTDWParams; var ContentType, Result: string;
  const RequestType: TRequestType);
var
 s : TStringlist;
...
procedure TServerMethodDM2.DWServerContext1ContextListzsendReplyRequest(
  const Params: TRESTDWParams; var ContentType, Result: string;
  const RequestType: TRequestType);
var
 s : TStringlist;
...
procedure TServerMethodDM2.DWServerEvents1EventsassynceventReplyEvent(
  var Params: TRESTDWParams; var Result: string);
Var
...
procedure TServerMethodDM2.DWServerEvents1EventseventdatetimeReplyEvent(
  var Params: TRESTDWParams; var Result: string);
begin
 Params.ItemsString['result'].AsDateTime := Params.ItemsString['mydatetime'].AsDateTime + 1;
end;

procedure TServerMethodDM2.DWServerEvents1EventseventintReplyEvent(
  var Params: TRESTDWParams; var Result: string);
begin
 Params.ItemsString['result'].AsInteger := Random(Params.ItemsString['mynumber'].AsInteger);
end;

procedure TServerMethodDM2.DWServerEvents1EventsgetemployeeDWReplyEvent(
  var Params: TRESTDWParams; var Result: string);
begin
 employeeReplyEvent(Params, Params.JsonMode, Result);
end;

procedure TServerMethodDM2.DWServerEvents1EventsgetemployeeReplyEvent(
  var Params: TRESTDWParams; var Result: string);
Begin
 employeeReplyEvent(Params, Params.JsonMode, Result);
End;

procedure TServerMethodDM2.DWServerEvents1EventshelloworldRDWReplyEvent(
  var Params: TRESTDWParams; var Result: string);
begin
 Params.ItemsString['result'].AsString := 'Hello World : ' + QuotedSTR(Params.ItemsString['entrada'].AsString);
end;

procedure TServerMethodDM2.DWServerEvents1EventshelloworldReplyEvent(
  var Params: TRESTDWParams; var Result: string);
begin
 Result := Format('Hello World :"%s"', [Params.ItemsString['entrada'].AsString]);
end;

procedure TServerMethodDM2.DWServerEvents1EventsloaddataseteventReplyEvent(
  var Params: TRESTDWParams; var Result: string);
Var
 JSONValue: TJSONValue;
BEGIN
...
procedure TServerMethodDM2.DWServerEvents2Eventshelloworld2ReplyEvent(
  var Params: TRESTDWParams; var Result: string);
begin
 Result := 'Sou eu ServerEvent2';
end;

procedure TServerMethodDM2.DWSETESTEEventsservertimeReplyEventByType(
...
Function TServerMethodDM2.GetGenID(GenName  : String): Integer;
Var
...
procedure TServerMethodDM2.RDWSEDadosEventshelloworldReplyEventByType(
  var Params: TRESTDWParams; var Result: string;
  const RequestType: TRequestType; var StatusCode: Integer;
  RequestHeader: TStringList);
begin
...
procedure TServerMethodDM2.RESTDWDriverFD1PrepareConnection(
  var ConnectionDefs: TConnectionDefs);
begin
...
procedure TServerMethodDM2.ServerMethodDataModuleCreate(Sender: TObject);
begin
 vConnectFromClient := False;
 RESTDWPoolerFD.Active  := RestDWForm.CbPoolerState.Checked;
end;

procedure TServerMethodDM2.ServerMethodDataModuleGetToken(Welcomemsg,
...
procedure TServerMethodDM2.ServerMethodDataModuleMassiveProcess(
  var MassiveDataset: TMassiveDatasetBuffer; var Ignore: Boolean);
begin
...
Procedure TServerMethodDM2.ServerMethodDataModuleUserTokenAuth(Welcomemsg,
  AccessTag: string; Params: TRESTDWParams; AuthOptions: TRESTDWAuthTokenParam;
  Var ErrorCode: Integer; var ErrorMessage, TokenID: string;
  Var Accept: Boolean);
begin
...
PROCEDURE TServerMethodDM2.Server_FDConnectionBeforeConnect(Sender: TObject);
VAR
  Driver_BD: STRING;
  Porta_BD: STRING;
  Servidor_BD: STRING;
...
PROCEDURE TServerMethodDM2.Server_FDConnectionError(ASender, AInitiator: TObject; VAR AException: Exception);
BEGIN
