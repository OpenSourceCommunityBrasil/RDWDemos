...
type
  ...
  TForm2 = class(TForm)
    ...
    RESTDWClientSQL1AUD_DATA_ALT: TDateTimeField;
    RESTDWClientSQL1AUD_DATA_CAD: TDateTimeField;
    RESTDWClientSQL1AUD_USER_ALT: TLargeintField;
    RESTDWClientSQL1AUD_USER_CAD: TLargeintField;
    RESTDWClientSQL1CLASSE_ID_ENTRADA: TLargeintField;
    RESTDWClientSQL1CLASSE_ID_SAIDA: TLargeintField;
    RESTDWClientSQL1DEPARTAMENTO_ID: TLargeintField;
    ...
    RESTDWClientSQL1ID_EXTERNO: TLargeintField;
    ...
    RESTDWClientSQL1PESSOA_BAIRRO: TStringField;
    RESTDWClientSQL1PESSOA_CAIXAPOSTAL: TStringField;
    RESTDWClientSQL1PESSOA_CEP: TStringField;
    RESTDWClientSQL1PESSOA_COMPLEMENTO: TStringField;
    RESTDWClientSQL1PESSOA_CONTATO: TStringField;
    RESTDWClientSQL1PESSOA_CPFCNPJ: TStringField;
    RESTDWClientSQL1PESSOA_DTNASCIMENTO: TDateField;
    RESTDWClientSQL1PESSOA_EMAIL: TStringField;
    RESTDWClientSQL1PESSOA_ID: TLargeintField;
    RESTDWClientSQL1PESSOA_IE: TStringField;
    RESTDWClientSQL1PESSOA_LOCALNASCIMENTO: TStringField;
    RESTDWClientSQL1PESSOA_LOGRADOURO: TStringField;
    RESTDWClientSQL1PESSOA_MUNICIPIO: TStringField;
    RESTDWClientSQL1PESSOA_NOMEFANTASIA: TStringField;
    RESTDWClientSQL1PESSOA_NUMERO: TStringField;
    RESTDWClientSQL1PESSOA_OBSERVACOES: TStringField;
    RESTDWClientSQL1PESSOA_RAZAOSOCIAL: TStringField;
    RESTDWClientSQL1PESSOA_RG: TStringField;
    RESTDWClientSQL1PESSOA_SITE: TStringField;
    RESTDWClientSQL1PESSOA_STATUS: TStringField;
    RESTDWClientSQL1PESSOA_TELEFONE: TStringField;
    RESTDWClientSQL1PESSOA_TIPO: TStringField;
    RESTDWClientSQL1PESSOA_TPCLIENTE: TStringField;
    RESTDWClientSQL1PESSOA_TPFACTORY: TStringField;
    RESTDWClientSQL1PESSOA_TPFINANCEIRA: TStringField;
    RESTDWClientSQL1PESSOA_TPFORNECEDOR: TStringField;
    RESTDWClientSQL1PESSOA_TPFUNCIONARIO: TStringField;
    RESTDWClientSQL1PESSOA_TPTRANSPORTE: TStringField;
    RESTDWClientSQL1PESSOA_TRATAMENTO: TStringField;
    RESTDWClientSQL1PESSOA_UF: TStringField;
    RESTDWClientSQL1PHONE_EXT1: TStringField;
    RESTDWClientSQL1PLANTA_ID: TLargeintField;
