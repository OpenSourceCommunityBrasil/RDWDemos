...
Uses LCL, LCLIntf, LCLType, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, uSock, IniFiles, IBConnection, db,
  uRESTDWIdBase,
...
uses
 {$IFNDEF FPC}ShellApi,{$ENDIF}uRESTDWDataUtils, uRESTDWConsts, udmwebpascal;
...
Begin
 ...
 RESTDWIdServicePooler1.RootPath          := IncludeTrailingPathDelimiter(ExtractFilePath(Application.ExeName) + 'www');
 PageControl1.ActivePage              := tsConfigs;
End;
