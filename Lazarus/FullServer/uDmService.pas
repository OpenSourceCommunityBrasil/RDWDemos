...
uses
  SysUtils, Classes, db, uRESTDWDatamodule, Dialogs,
  ZConnection, ZDataset, uRESTDWDataUtils, uRESTDWConsts,
  uRESTDWServerEvents, uRESTDWServerContext, uRESTDWBasicDB,
  uRESTDWParams, uRESTDWZeosDriver, uRESTDWAuthenticators;
...
uses RestDWServerFormU, uRESTDWTools, uRESTDWJSONObject;
